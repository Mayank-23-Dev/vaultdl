...
import { Download, ListVideo, History, Image, Settings, Wifi, ChevronRight } from "lucide-react";
    ...
    <div className="flex h-screen bg-[rgb(4_4_6)]">
      ...
      <aside className="w-[220px] bg-[rgb(6_6_9)] border-r border-white/[0.05] flex flex-col shrink-0">
        ...
        <div className="h-[52px] px-4 flex items-center gap-3 border-b border-white/[0.05] shrink-0">
          <div className="w-7 h-7 rounded-lg bg-white flex items-center justify-center shrink-0 shadow-[0_0_12px_rgba(255,255,255,0.15)]">
          ...
          <span className="ml-auto text-[9px] mono text-white/15 font-medium bg-white/[0.04] px-1.5 py-0.5 rounded-sm border border-white/[0.06]">v2.4</span>
        </div>
